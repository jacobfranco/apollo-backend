            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.languages = new java.util.ArrayList<java.lang.String>(_list44.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem45;
                for (int _i46 = 0; _i46 < _list44.size; ++_i46)
                {
                  _elem45 = iprot.readString();
                  struct.languages.add(_elem45);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.languages != null) {
        if (struct.isSetLanguages()) {
          oprot.writeFieldBegin(LANGUAGES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter47 : struct.languages)
            {
      ...
      if (struct.isSetLanguages()) {
        {
          ...
          for (java.lang.String _iter48 : struct.languages)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.languages = new java.util.ArrayList<java.lang.String>(_list49.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = iprot.readString();
            struct.languages.add(_elem50);
          }
        }
        struct.setLanguagesIsSet(true);
      }

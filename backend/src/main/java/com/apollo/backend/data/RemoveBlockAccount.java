...
public class RemoveBlockAccount implements org.apache.thrift.TBase<RemoveBlockAccount, RemoveBlockAccount._Fields>, java.io.Serializable, Cloneable, Comparable<RemoveBlockAccount> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("RemoveBlockAccount");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new RemoveBlockAccountStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new RemoveBlockAccountTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(RemoveBlockAccount.class, metaDataMap);
  }

  public RemoveBlockAccount() {
  }
   ...
   */
  public RemoveBlockAccount(RemoveBlockAccount other) {
  ...
  @Override
  public RemoveBlockAccount deepCopy() {
    return new RemoveBlockAccount(this);
  }
  ...
  public RemoveBlockAccount setAccountId(long accountId) {
    this.accountId = accountId;
    setAccountIdIsSet(true);
    return this;
  }
  ...
  public RemoveBlockAccount setTargetId(long targetId) {
    this.targetId = targetId;
    setTargetIdIsSet(true);
    return this;
  }
  ...
  public RemoveBlockAccount setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof RemoveBlockAccount)
      return this.equals((RemoveBlockAccount)that);
    return false;
  }

  public boolean equals(RemoveBlockAccount that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(RemoveBlockAccount other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("RemoveBlockAccount(");
    boolean first = true;
  ...
  private static class RemoveBlockAccountStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public RemoveBlockAccountStandardScheme getScheme() {
      return new RemoveBlockAccountStandardScheme();
    }
  }

  private static class RemoveBlockAccountStandardScheme extends org.apache.thrift.scheme.StandardScheme<RemoveBlockAccount> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, RemoveBlockAccount struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, RemoveBlockAccount struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class RemoveBlockAccountTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public RemoveBlockAccountTupleScheme getScheme() {
      return new RemoveBlockAccountTupleScheme();
    }
  }

  private static class RemoveBlockAccountTupleScheme extends org.apache.thrift.scheme.TupleScheme<RemoveBlockAccount> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, RemoveBlockAccount struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, RemoveBlockAccount struct) throws org.apache.thrift.TException {

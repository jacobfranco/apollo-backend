            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.languages = new java.util.ArrayList<java.lang.String>(_list64.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = iprot.readString();
                  struct.languages.add(_elem65);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.languages != null) {
        if (struct.isSetLanguages()) {
          oprot.writeFieldBegin(LANGUAGES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter67 : struct.languages)
            {
      ...
      if (struct.isSetLanguages()) {
        {
          ...
          for (java.lang.String _iter68 : struct.languages)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.languages = new java.util.ArrayList<java.lang.String>(_list69.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = iprot.readString();
            struct.languages.add(_elem70);
          }
        }
        struct.setLanguagesIsSet(true);
      }

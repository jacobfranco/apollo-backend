...
public class StatusContent extends org.apache.thrift.TUnion<StatusContent, StatusContent._Fields> {
  ...
  static {
    ...
    tmpMap.put(_Fields.BOOST, new org.apache.thrift.meta_data.FieldMetaData("boost", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, BoostStatusContent.class)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(StatusContent.class, metaDataMap);
  }
  ...
  public StatusContent(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public StatusContent(StatusContent other) {
    super(other);
  }
  @Override
  public StatusContent deepCopy() {
    return new StatusContent(this);
  }

  public static StatusContent normal(NormalStatusContent value) {
    StatusContent x = new StatusContent();
    x.setNormal(value);
    return x;
  }

  public static StatusContent reply(ReplyStatusContent value) {
    StatusContent x = new StatusContent();
    x.setReply(value);
    return x;
  }

  public static StatusContent boost(BoostStatusContent value) {
    StatusContent x = new StatusContent();
    x.setBoost(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case BOOST:
        if (value instanceof BoostStatusContent) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type BoostStatusContent for field 'boost', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case BOOST:
          if (field.type == BOOST_FIELD_DESC.type) {
            BoostStatusContent boost;
            boost = new BoostStatusContent();
            boost.read(iprot);
            return boost;
          } else {
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case REPLY:
        ...
        return;
      case BOOST:
        BoostStatusContent boost = (BoostStatusContent)value_;
        boost.write(oprot);
        return;
      default:
  ...
  public BoostStatusContent getBoost() {
    if (getSetField() == _Fields.BOOST) {
      return (BoostStatusContent)getFieldValue();
    } else {
  ...
  public void setBoost(BoostStatusContent value) {
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof StatusContent) {
      return equals((StatusContent)other);
    } else {
      return false;
    }
  }

  public boolean equals(StatusContent other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(StatusContent other) {

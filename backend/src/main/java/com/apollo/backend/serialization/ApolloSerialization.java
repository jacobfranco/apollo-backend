...
public class ApolloSerialization extends ThriftSerialization<TBase<?, ?>> {
    ...
    protected Map<Integer, Class<? extends TBase<?, ?>>> typeIds() {
        ...
        List<Class<? extends TBase<?, ?>>> classes = Arrays.asList(
                ...
                (Class<? extends TBase<?, ?>>) Age.class,
                (Class<? extends TBase<?, ?>>) Application.class,
                ...
                (Class<? extends TBase<?, ?>>) Country.class,
                ...
                (Class<? extends TBase<?, ?>>) Image.class,
                ...
                (Class<? extends TBase<?, ?>>) Player.class,
                ...
                (Class<? extends TBase<?, ?>>) Region.class,
                ...
                (Class<? extends TBase<?, ?>>) SocialMediaAccount.class,
                (Class<? extends TBase<?, ?>>) SpaceFanout.class,
                (Class<? extends TBase<?, ?>>) StandingRoster.class,
                ...
                (Class<? extends TBase<?, ?>>) StatusWithId.class,
                (Class<? extends TBase<?, ?>>) Team.class,

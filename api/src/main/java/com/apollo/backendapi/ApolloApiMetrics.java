...
@Component
public class ApolloApiMetrics implements WebFilter {
    ...
    public static final ApolloApiConcurrentFixedMap<LocalDateTime, Metrics> HOURLY_METRICS = new ApolloApiConcurrentFixedMap<>(24);

...
public class GetScheduledStatus {
    ...
    public static class StatusParams {
        ...
        public StatusParams(Status status) {
            ...
            this.visibility = ApolloApiHelpers.createStatusVisibility(visibility);
            if (pollContent != null) {
    ...
    public GetScheduledStatus(StatusWithId scheduledStatus) {
      this.id = ApolloHelpers.serializeStatusPointer(new StatusPointer(scheduledStatus.status.authorId, scheduledStatus.statusId));

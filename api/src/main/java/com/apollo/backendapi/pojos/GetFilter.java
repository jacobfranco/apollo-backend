...
public class GetFilter {
    ...
    public static class FilterStatus {
        ...
        FilterStatus(long filterId, StatusPointer statusPointer) {
            String comboId = ApolloHelpers.serializeStatusPointer(statusPointer);
    ...
    public GetFilter(long filterId, Filter filter) {
        ...
        this.context = filter.contexts.stream().map(ApolloApiHelpers::createFilterContext).collect(Collectors.toList());
        this.filter_action = ApolloApiHelpers.createFilterAction(filter.action);
